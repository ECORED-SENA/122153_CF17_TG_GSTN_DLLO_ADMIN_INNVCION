...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.align-items-start.mb-4
      ...
      .col-lg-8
        TabsA.color-acento-contenido.grs.mb-3
          .tarjeta.color-acento-botones.fnd-3.p-4(titulo="Funcional")
            p Examina primordialmente las estructuras formales e informales de la comunicación, aquellas prácticas que tienen relación con el proceso de producción, mantenimiento, atención al cliente y la innovación. Los métodos y técnicas aplicables son:
            ul.lista-ul--color.cir.fa-lista
              li 
                i.fas.fa-circle.circle
                span.mb-0 Entrevista.
              li 
                i.fas.fa-circle.circle
                span.mb-0 Cuestionario.
              li 
                i.fas.fa-circle.circle
                span.mb-0 Análisis de transmisión de mensajes.
              li 
                i.fas.fa-circle.circle
                span.mb-0 Análisis de experiencias de comunicación críticas.
              li 
                i.fas.fa-circle.circle
                span.mb-0 Análisis de redes de comunicación.
              li 
                i.fas.fa-circle.circle
                span.mb-0 Entrevista grupal.            
          .tarjeta.color-acento-botones.fnd-3.p-4(titulo="Cultural")
            p Su propósito es el de descubrir los valores y principios que rigen una organización y el grado de conocimiento, congruencia y apropiación de los miembros o integrantes de la misma en su comportamiento como empresa. Los principios y valores pueden determinarse a partir de los campos en que se evidencian, por lo que mientras más manifestaciones sean analizadas, más enriquecido el ejercicio y más certero será el diagnóstico. Se habla de manifestaciones en cualquiera de los siguientes campos:
            ul.lista-ul--color.cir.fa-lista
              li 
                i.fas.fa-circle.circle
                span.mb-0 #[b Espirituales:] filosofía, ideología, símbolos, historia o mitos.
              li 
                i.fas.fa-circle.circle
                span.mb-0 #[b Conductuales:] comportamiento no verbal, actos rituales, formas de interactuar, lenguaje.
              li 
                i.fas.fa-circle.circle
                span.mb-0 #[b Estructurales:] políticas y procedimientos, normas, estructura de autoridad.
              li 
                i.fas.fa-circle.circle
                span.mb-0 #[b Materiales:] tecnología, instalaciones, mobiliario y equipo.

    p Y las técnicas para obtener esta información pueden ser cualitativas o cuantitativas.               
        ...
        AcordionA.mb-5(tipo="a" clase-tarjeta="tarjeta tarjeta--azul fnd-5")
          .row(titulo="Cualitativas")
            ul.lista-ul--color.nar.fa-lista
              li.mb-0 
                i.fas.fa-check
                span.mb-0 #[b Observación:] se da cuando el observador lo realiza como parte del grupo, participando en actividades dispuestas para el ejercicio diagnóstico.
              li.mb-0 
                i.fas.fa-check
                span.mb-0 #[b Entrevistas individuales:] se dan a partir de la generación de un ambiente de confianza y afinidad entre el entrevistador y el entrevistado.
              li.mb-0 
                i.fas.fa-check
                span.mb-0 #[b Análisis de documentos:] se reúnen documentos con el fin de ser analizados e interpretados.
              li.mb-0 
                i.fas.fa-check
                span.mb-0 #[b Discusión en pequeños grupos:] sesiones grupales y dirigidas.
              li.mb-0 
                i.fas.fa-check
                span.mb-0 #[b Dramatización:] proporciona información sobre la percepción que las personas tienen de diversos temas.
          .row(titulo="Cuantitativas")
            ul.lista-ul--color.nar.fa-lista
              li 
                i.fas.fa-check
                span.mb-0 #[b Encuesta:] un cuestionario con preguntas que permitan aproximarse a la situación actual de estudio o análisis.
              li 
                i.fas.fa-check
                span.mb-0 #[b Análisis de redes de comunicación:] se analiza cómo es la comunicación entre las personas dentro de la organización.

    p Ahora, la obtención de información hace viable el uso de esa información para la toma de decisiones, a partir del análisis e interpretación. Para esto, existen unas herramientas y técnicas, que se aplican una vez que se cuenta con el contenido del diagnóstico.
    ...
    p.mb-4 A continuación, se presentan algunos instrumentos de análisis estratégico:
    ...
    ul.lista-ul--color.mor.mb-4
      li 
        i.fas.fa-square
        span.mb-0.h3.text-black Matrices de análisis estratégico
    
    .row.justify-content-between.mb-4
      .col-md-7.col-lg-7
        p Las matrices estratégicas son representaciones que muestran de manera sintética, algunos parámetros o características para tener en cuenta en la toma de decisiones; es decir, para definir la estrategia apropiada de intervención en función de las metas y los objetivos estratégicos de la empresa, teniendo en cuenta la situación del entorno, las capacidades internas y los recursos con los que se cuenta para proceder.
      .col-md-5.col-lg-5.mb-3
    ...
    .row.justify-content-center.mb-4.ddd
      ...
      .col-lg-4.d-flex
        .tarjeta.color-acento-botones.p-4.fnd-1
          .row.justify-content-center.mb-3
            .col-8
              img.img-150(src='@/assets/curso/temas/tema2/img-9.svg' alt='')
          h4.text-center Matrices de evaluación
            ...
            .col
              .row.justify-content-between.align-items-center
                .col.mb-3.mb-sm-0
                  ...
                  p.mb-0 #[b ¡Tenga presente!] Determinadas matrices existentes sirven para apoyar las diferentes etapas en las que se puede requerir el análisis estratégico; por ejemplo, hay matrices que resultan útiles para la recopilación de información, otras para el proceso de adaptación y otras para el proceso de decisión. Analice algunas de ellas en el documento #[b Matrices análisis estratégico.]
                .col-sm-auto
                  a.boton.color-acento-botones.texto-blanco(:href="('downloads/matrices_analisis_estrategico.pdf')" target="_blank")
                    span Descargar 
                    i.fas.fa-download
      ...
      .col-md-8.col-lg-10
        .bloque-texto-a.color-primario.p-4.p-md-5.fnd-8
          .row.m-0.align-items-center.justify-content-between
            .col-lg-3
                p.text-black Los principales motivadores para hacer uso de los indicadores de gestión son:
            .col-lg-9.mb-4.mb-lg-0
              .bloque-texto-a__texto.p-4.mb-sm-3
                ul.lista-ul--color.nar.fa-lista
                  li 
                    i.fas.fa-check
                    span.mb-0 Contribuyen activamente y de manera contundente en la toma de decisiones.
                  li 
                    i.fas.fa-check
                    span.mb-0 Hacen manifiesta la eficiencia de las actividades y acciones de la empresa, conjuntamente.                  
                  li 
                    i.fas.fa-check
                    span.mb-0 Facilitan la identificación de las problemáticas que se presentan y las que podrían llegar a surgir.

    p.mb-4 Existen diversos tipos de indicadores de gestión:
    ...
    .row.justify-content-center.align-items-center.mb-4
      .col-lg-10
        .titulo-sexto.color-acento-contenido.mb-3(data-aos='fade-right')
          p.mb-0 #[b Figura 5.] Pasos para generar indicadores de gestión
        figure.px-3
          img(src='@/assets/curso/temas/tema2/img-13-.svg' alt="Imagen que especifica los 10 pasos para generar indicadores de gestión. 1. Definir el objetivo de lo que se quiere medir. 2. Identificar las variables a evaluar. 3. Identificar las fuentes de información. 4. Concretar el objetivo del indicador. 5. Identificar los responsables del indicador. 6. Identificar la frecuencia de medición. 7. Fijar una meta o una estándar al cual se quiere llegar. 8. Definir la fórmula que aportará el indicador. 9. Definir el nivel de aplicabilidad. 10. Asignar el código y nombre del indicador.")  
    ...
    ul.lista-ul--color.mor.mb-4
      li 
        i.fas.fa-square
        span.h3.mb-0 Informes de diagnóstico

    p.mb-4 Para finalizar, hablemos sobre los informes de diagnóstico, y para hacerlo, lo invitamos a ver el siguiente video.
    ...
    .mb-4
      ...
      figcaption Video. Informes de diagnóstico

    p Finalizamos así la temática sobre innovación, análisis y diagnóstico empresarial.
