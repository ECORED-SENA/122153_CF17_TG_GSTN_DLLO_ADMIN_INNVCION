...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
      ...
      .col-md-6.col-lg-4.mb-5.mb-lg-0.row2
        .tarjeta-avatar
          ...
          .ini.fnd-6.color-primario.b-r-d  
            .p-4.mt-3
              h4.text-center Enfoque #[em push] 
    ...
    .row.justify-content-center.align-items-start.mb-5
      .col-lg-8
        TabsA.color-acento-contenido.grs(lang="es")
          .tarjeta.color-acento-botones.fnd-3.p-4(titulo="Creación de conocimiento")
            p Esta creación se da a partir del trabajo colaborativo y la acumulación de experiencias; tiene lugar entre los colaboradores, la organización y los socios. Representa la base que incrementa y permite la disponibilidad del conocimiento creado por las personas integrantes de la empresa, a través del desarrollo de nuevos productos, servicios, alianzas estratégicas, entre otros.             
          .tarjeta.color-acento-botones.fnd-3.p-4(titulo="Absorción de conocimiento")
          ...
          .tarjeta.color-acento-botones.fnd-3.p-4(titulo="Integración de conocimiento")
          ...
          .tarjeta.color-acento-botones.fnd-3.p-4(titulo="Reconfiguración de conocimiento")
    ...
    p.mb-4 Asimismo, dichos procesos se encuentran soportados por cuatro tipos de recursos. Conozcamos cada uno de ellos:
      ...
      .py-3.py-md-4(titulo="Capital humano")
        .row    
          .col-md-5.mb-4.mb-md-0
            figure.px-3
              img.img-240(src='@/assets/curso/temas/tema1/img-8.svg')                     
          .col-md-7.mb-4.mb-md-0
            p.mb-3 Hace referencia al conocimiento y a las habilidades de las personas que posibilitan los cambios y el crecimiento económico; puede ser desarrollado por la formación profesional como actualización y renovación de los talentos. De manera contundente, ha quedado demostrado que el capital humano absorbe el conocimiento y llega a la creación de capacidades para innovar. 
      .py-3.py-md-4(titulo="Liderazgo")
        .row    
          .col-md-5.mb-4.mb-md-0
            figure.px-3
              img.img-240(src='@/assets/curso/temas/tema1/img-9.svg')                     
          .col-md-7.mb-4.mb-md-0
            p.mb-3 Resulta un factor determinante en el proceso de innovación, puesto que se posibilita a partir de él, la influencia para la transformación; es decir, los líderes tienen la capacidad de convencer a sus equipos de trabajo para que transiten de priorizar sus necesidades o intereses individuales y se enfoquen en los intereses del grupo. El liderazgo transformacional delega en el líder la capacidad de orientación para con su equipo de trabajo, y este lo comprende de esa manera, aceptando la influencia desde el aporte de recursos de gran valor.
      .py-3.py-md-4(titulo="Estructuras y sistemas")
        .row    
          .col-md-5.mb-4.mb-md-0
            figure.px-3
              img.img-240(src='@/assets/curso/temas/tema1/img-10.svg')                     
          .col-md-7.mb-4.mb-md-0
            p.mb-3 Tienen la capacidad de obstaculizar o posibilitar el ejercicio de innovación, a partir de la transferencia del conocimiento. Las estructuras y los sistemas deben ser flexibles para facilitar el proceso y, de esta manera, generar los canales de comunicación y jerarquías necesarias para implementar un desempeño organizacional positivo en el marco de un ejercicio de innovación.
      .py-3.py-md-4(titulo="Cultura organizativa")
        .row    
          .col-md-5.mb-4.mb-md-0.px-5
            figure.px-3
              img.img-240(src='@/assets/curso/temas/tema1/img-11.svg')                     
          .col-md-7.mb-4.mb-md-0
            p.mb-3 Se refiere a aquella que fomenta la interacción y el trabajo colectivo para un asertivo proceso de innovación, básicamente para las nuevas ideas. Así mismo, representa el conjunto de valores, normas y comportamientos que rigen el devenir de la organización, de tal manera que, una adecuada aceptación de los mismos, permite el mejoramiento de la creatividad y, por ende, un alto grado de innovación.      

    
    Separador 
    #t_1_1.titulo-segundo.color-acento-contenido
      h2 1.1 Etapas del proceso de innovación
            
    p.mb-4 Desde otro punto de vista, el proceso innovador puede ser explicado a partir de tres momentos, cuyo desarrollo y soporte se relacionan con diferentes herramientas que serán explicadas más adelante. Estos tres momentos son expuestos en la Figura 1:

    .row.justify-content-center.align-items-center.mb-4
      .col-lg-10
        .titulo-sexto.color-acento-contenido.mb-3(data-aos='fade-right')
          p.mb-0 #[b Figura 1.] Momentos del proceso innovador
        figure.px-3
          img(src='@/assets/curso/temas/tema1/img-12.svg' alt="Figura que señala los 3 momentos del proceso innovador los cuales son: Descubrir (entrevistas, mapa de empatía, mapa de experiencia del cliente, visual Thinking||, etnografías) Idear (Brainstorming, 6 sombreros para pensar) y Realizar/Implementar (pruebas de concepto).")  

    p Cuando se habla de descubrir, se hace referencia a la capacidad de observar y determinar las necesidades, los requerimientos o las oportunidades de mejora de los procesos, productos o servicios. Esta fase procura recabar información de interés para identificar dónde se debe realizar una intervención.
    p.mb-4 Algunas de las herramientas de apoyo para esa recolección de información pueden ser: 
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-7.mb-4
        ImagenInfografica.color-acento-botones
          ...
          .tarjeta.color-secundario.fnd-4-.p-3(x="49.2%" y="5.8%" numero="+")
            p.mb-0 Este color tiene el significado de control y su función es gestionar la dinámica de mantener el enfoque de los participantes para procurar los resultados acordes y exitosos. Es una posición mediadora y de liderazgo.
          .tarjeta.color-secundario.fnd-4-.p-3(x="75.2%" y="34%" numero="+")
            p.mb-0 Hace alusión al crecimiento, a la energía y al pensamiento creativo. Es una posibilidad para generar ideas alrededor de las necesidades o problemáticas planteadas.
          .tarjeta.color-secundario.fnd-4-.p-3(x="75.3%" y="63.3%" numero="+")
            p.mb-0 Es la oscuridad, y sitúa al participante en un punto de vista crítico y cauteloso; es la perspectiva quizás más utilizada cotidianamente, puesto que trata de identificar peligros y posibles problemas para sobrevivir. Es un estado de alerta para defenderse del peligro, de la ilegalidad o de un problema.
          .tarjeta.color-secundario.fnd-4-.p-3(x="48.9%" y="94.2%" numero="+")
            p.mb-0 Un color que transmite pasión y, por ende, permite manifestar y expresar sentimientos puros, utilizar la intuición y la irracionalidad y darle el toque humano a las decisiones a tomar. 
          .tarjeta.color-secundario.fnd-4-.p-3(x="21.8%" y="63.2%" numero="+")
            p.mb-0 Transmite neutralidad y lleva al participante a tener una perspectiva objetiva de la situación, donde no puede involucrar emociones u opiniones, solamente datos, hechos y cifras.
          .tarjeta.color-secundario.fnd-4-.p-3(x="23%" y="34%" numero="+")
            p.mb-0 Es la perspectiva optimista de la situación y permite identificar las ventajas de una idea o propuesta; es el opuesto del sombrero negro, de modo que, es la posición más difícil de aplicar porque el ser humano no está dotado con mecanismo optimista; sin embargo, se debe incurrir en el error del sí por el sí. Es el sombrero de los visionarios y soñadores.

      .col-lg-10
        .cajon.color-acento-botones.p-4.fnd-2
          h4.mb-2 Algunos de los beneficios de esta técnica son:
          p.mb-0 El fomento del pensamiento de forma paralela, el impulso del pensamiento en toda su dimensión, diferenciar y separar el ego del desempeño. El hacer uso de este método, permite tener la visión integral del problema o reto a tratar. El tiempo de uso de cada sombrero debe ser limitado y corto, aproximadamente 1 minuto, para que sea aprovechado y se logren varias opiniones o propuestas en poco tiempo. Una vez que los roles dan su opinión, el sombrero azul tiene la potestad para cambiarlos, incluyendo el suyo propio.

    p En el recorrido de las fases anteriores, se cuenta con la problemática identificada y con las ideas o propuestas de solución; ahora, el paso siguiente es la #[b realización/implementación,] donde se materializa y se actúa sobre lo analizado, con antelación. Una de las herramientas que aporta para dar estructura a este proceso, es la denominada prueba de concepto, tipo de investigación de mercados, que implica hacer preguntas y cuestionamientos a los consumidores o clientes, antes de salir con el producto o servicio al mercado; es la alternativa de poner a prueba la aceptación que tendría y la intención de adquirirlo o pagar por él. Los elementos adquiridos mediante las pruebas de concepto, ayudan a diseñar productos o servicios eficientes para el mercado.
    p.mb-4 Existen varias formas para realizar las pruebas de concepto, entre ellas están:
      ...
      .col-lg-8
        PasosA.color-acento-contenido(tipo="n")
          .row
            .col-md-3
              figure.mb-3.px-2
                img.img-95(src='@/assets/curso/temas/tema1/img-21.svg')
            .col-md-9.mb-4.mb-md-0
              h4 Pruebas de comparación
              p Donde se presentan dos o más conceptos a los encuestados; el propósito es que ambas propuestas sean comparadas, utilizando preguntas de calificación o, sencillamente, eligiendo el mejor concepto.
          .row
            .col-md-9.mb-4.mb-md-0
              h4.text-left Pruebas monádicas
              p.text-left Donde el público se divide en grupos y a cada grupo se le muestra un solo concepto; es un método de profundidad, donde se evalúa un concepto minuciosamente; esas pruebas suelen ser cortas y muy específicas. 
            .col-md-3
              figure
                img.img-95(src='@/assets/curso/temas/tema1/img-22.svg')
          .row
            .col-md-3
              figure.mb-3.px-2
                img.img-95(src='@/assets/curso/temas/tema1/img-23.svg')
            .col-md-9.mb-4.mb-md-0
              h4 Pruebas monádicas secuenciales
              p Al igual que el anterior, el público es dividido en varios grupos; sin embargo, la diferencia está en que a cada grupo se le presentan todos los conceptos de manera aleatoria para más objetividad; a todos los grupos se les hace el mismo conjunto de preguntas y se obtiene información de valor para el análisis posterior.
          .row
            .col-md-9.mb-4.mb-md-0
              h4.text-left Pruebas protomonádicas
              p.text-left Son dos pruebas en una; la primera aplicada es la monádica secuencial y, posteriormente, la prueba de comparación, es decir, los participantes encuestados, primero evalúan múltiples conceptos y luego eligen el de su predilección. Es un método útil para confirmar los resultados de la monádica secuencial, validando si el concepto que fue seleccionado en la prueba de comparación, resulta compatible con los conocimientos que se obtuvieron de cada concepto.
            .col-md-3
              figure
                img.img-95(src='@/assets/curso/temas/tema1/img-24.svg')

    p Luego de este recorrido por las fases, etapas o momentos donde se puede dar la innovación, podría decirse que: la innovación representa una posibilidad, para las empresas, de generar #[b valor agregado ]a sus clientes, consumidores y, por ende, se traduce en mayores y mejores utilidades; todo esto a partir de metodologías y herramientas que facilitan el ejercicio de innovar. 


    Separador 
    #t_1_2.titulo-segundo.color-acento-contenido
      h2 1.2 Metodologías de innovación

    .row.justify-content-between.align-items-center.mb-4
      .col-md-6.col-lg-5.mb-3
        img(src='@/assets/curso/temas/tema1/img-25.png')
      .col-md-6.col-lg-7
        p Cada metodología da respuesta al entorno y contexto donde se desenvuelven y aplican soluciones al problema o situación que se presenta a través de la innovación; son alternativas que surgen con el fin de ser adoptadas por las empresas, según su naturaleza, enfoque, o necesidad. 

    p.mb-4 Algunas de las metodologías más utilizadas en el campo empresarial, para potencializar elementos de innovación son:
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-10
        .cajon.color-acento-botones.p-4.mb-5.fnd-2.px-5
          h4 ¡Nota importante!
          p.mb-0 Las metodologías de innovación son consideradas como la hoja de ruta que da una organización al proceso creativo, generando eficiencias en el uso de los recursos, enfoque en las metas, o resultados y la maximización de la utilidad. 


    ul.lista-ul--color.mor.mb-4
      li 
        i.fas.fa-square
        span.mb-0.h3.text-black Metodologías ágiles 

    p A pesar de las dinámicas del contexto, actualmente, algunas empresas se han quedado rezagadas con los procesos de innovación y no están respondiendo a las exigencias que presenta el mercado. Las metodologías ágiles son aquellas que posibilitan la adaptación de la forma de trabajo a las condiciones de la necesidad o del requerimiento, de tal manera que se consiga la flexibilidad e inmediatez para el planteamiento de la solución.
    p.mb-4 Algunas de las ventajas de las metodologías ágiles son:
    
    SlyderF.mb-4.row(columnas="col-md-6 col-lg-4")
      .tarjeta.color-acento-botones.p-4.fnd-11.tarjeta-avatar1
        .row.justify-content-center.mb-3
          .col-8
            img.img-150(src='@/assets/curso/temas/tema1/img-36.svg' alt='')
        p.text-center.px-3 Mejora la calidad del producto, en tanto fomenta la proactividad en los equipos de trabajo para la búsqueda de la excelencia del producto o servicio.        
      .tarjeta.color-acento-botones.p-4.fnd-11.tarjeta-avatar1
        .row.justify-content-center.mb-3
          .col-8
            img.img-150(src='@/assets/curso/temas/tema1/img-37.svg' alt='')
        p.text-center.px-3 Mejora la satisfacción del cliente, dado que, este se siente involucrado y comprometido con el proceso, viviendo en tiempo real las mejoras que se aplican al producto o servicio.
      .tarjeta.color-acento-botones.p-4.fnd-11.tarjeta-avatar1
        .row.justify-content-center.mb-3
          .col-8
            img.img-150(src='@/assets/curso/temas/tema1/img-38.svg' alt='')
        p.text-center.px-3 Mayor motivación de los trabajadores, a partir de la autogestión que se promueve y la disposición de condiciones para facilitar la capacidad creativa e innovativa.
      .tarjeta.color-acento-botones.p-4.fnd-11.tarjeta-avatar1
        .row.justify-content-center.mb-3
          .col-8
            img.img-150(src='@/assets/curso/temas/tema1/img-39.svg' alt='')
        p.text-center.px-3 Trabajo colaborativo, teniendo en cuenta los roles y la división del trabajo, así como también los ejercicios colectivos, reuniones y actividades que permiten mayor organización del trabajo.
      .tarjeta.color-acento-botones.p-4.fnd-11.tarjeta-avatar1
        .row.justify-content-center.mb-3
          .col-8
            img.img-150(src='@/assets/curso/temas/tema1/img-40.svg' alt='')
        p.text-center.px-3 Uso de métricas más relevantes, siendo utilizadas para la estimación de los costos, el tiempo, el rendimiento, como parámetros de medida para ser conscientes de lo que sucede y dónde sucede.
      .tarjeta.color-acento-botones.p-4.fnd-11.tarjeta-avatar1
        .row.justify-content-center.mb-3
          .col-8
            img.img-150(src='@/assets/curso/temas/tema1/img-41.svg' alt='')
        p.text-center.px-3 Mayor control y capacidad de predicción, teniendo en cuenta que los miembros del equipo o la organización, puedan ejercer una labor de control sobre su trabajo, con la posibilidad de mejorar la estimación de los tiempos y los costos.
      .tarjeta.color-acento-botones.p-4.fnd-11.tarjeta-avatar1
        .row.justify-content-center.mb-3
          .col-8
            img.img-150(src='@/assets/curso/temas/tema1/img-42.svg' alt='')
        p.text-center.px-3 Reducción de costos, a partir de la gestión ágil del proyecto y logrando con ello la eliminación del escenario de fracaso, a través de la identificación de errores a lo largo del desarrollo de este. 

    p.mb-4 En la siguiente figura, se dan a conocer los principios de las metodologías ágiles, los cuales surgen para facilitar la comprensión del concepto.

    .row.justify-content-center.align-items-center.mb-5
      .col-lg-10
        .titulo-sexto.color-acento-contenido.mb-3(data-aos='fade-right')
          p.mb-0 #[b Figura 4.] Principios de las metodologías ágiles
        figure.px-3
          img(src='@/assets/curso/temas/tema1/img-43-.svg' alt="Figura que expone los cuatro principios de las metodologías ágiles las cuales son: -Dinámica de equipo y cultura: creación de una cultura efectiva de equipo, de apoyo, y acción colaborativa. -Colaboración del negocio: colaboración con los clientes para conseguir información pronto para validación o descarte de la hipótesis. -Entrega de valor: entrega del trabajo rápido consiguiendo retroalimentación para actuar prontamente. -Retrospectivas de aprendizaje continuo: reflexiones a partir de reuniones retrospectivas, para realizar los ajustes correspondientes al proceso o producto.")      

    .row.justify-content-center.align-items-center.mb-5
      .col-lg-10
        .cajon.color-acento-botones.p-4.fnd-2.px-5
            h4 ¡Importante!
            p.mb-0 Con metodologías ágiles, los profesionales pueden estar lo suficientemente preparados para tomar decisiones imprevistas y cambiar la orientación de los proyectos, siendo flexibles en el actuar y el proceder, sin que la empresa se afecte por daños irreversibles. 

    p.mb-4 Las metodologías ágiles que se explican a continuación, permiten la alineación entre los equipos de trabajo y el cliente o consumidor, así como también la identificación y resolución de problemáticas de forma ágil, la respuesta oportuna, la reducción de los riesgos, y un proyecto de calidad.
